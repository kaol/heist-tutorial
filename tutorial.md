...
Heist is a HTML or XML templating library.  It comes as default with
...
specifically to a tag like `<h:splice/>` or `<div id="${splice}"/>`.
...
tutorialSplices = do
  "foo" ## (pureSplice . textSplice) "hello world"
  "bar" ## barImpl
